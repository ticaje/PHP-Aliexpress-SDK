...
/**
 * Class OrderReceiptInfoResponder
 * @package Ticaje\AeSdk\Api\Artifact\Responder
 */
class OrderReceiptInfoResponder implements ApiResponderInterface, WorkerInterface
{
    use Responder;
    ...
    public function process(ContractResponseInterface $response): ApiResponderInterface
    {
        ...
        isset($content->error_response) ? $this->error($content->error_response) : $this->success($content->aliexpress_solution_order_receiptinfo_get_response);
        return $this;
    }
