...
/**
 * Class MerchantProfileResponder
 * @package Ticaje\AeSdk\Api\Artifact\Responder\Get
 */
class MerchantProfileResponder implements ApiResponderInterface, WorkerInterface
{
    use Responder;
    ...
    public function process(ContractResponseInterface $response): ApiResponderInterface
    {
        ...
        isset($content->error_response) ? $this->error($content->error_response) : $this->success($content->aliexpress_solution_merchant_profile_get_response);
        return $this;
    }
