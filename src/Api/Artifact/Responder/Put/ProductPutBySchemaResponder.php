...
/**
 * Class ProductPutBySchemaResponder
 * @package Ticaje\AeSdk\Api\Artifact\Responder\Put
 */
class ProductPutBySchemaResponder implements ApiResponderInterface, WorkerInterface
{
    use Responder;
    ...
    public function process(ContractResponseInterface $response): ApiResponderInterface
    {
        ...
        isset($content->error_response) ? $this->error($content->error_response) : $this->success($content->aliexpress_solution_schema_product_full_update_response);
        return $this;
    }
